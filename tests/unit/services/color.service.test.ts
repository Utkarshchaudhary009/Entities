...
const { colorService } = await setupServiceModule<
  typeof import("@/services/color.service")
>({
  serviceAlias: "@/services/color.service",
  serviceSourcePath: "../../../src/services/color.service",
