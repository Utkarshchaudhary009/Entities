...
const { discountService } = await setupServiceModule<
  typeof import("@/services/discount.service")
>({
  serviceAlias: "@/services/discount.service",
  serviceSourcePath: "../../../src/services/discount.service",
