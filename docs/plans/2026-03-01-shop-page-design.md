...
### Data Flow
1. **Catalog Payload:** An Edge-cached endpoint (`/api/shop/catalog`) returns a lightweight index of active products (`id`, `name`, `thumbnailUrl`, `price`, `categorySlug`), and revalidates this path on product API edit, create, or delete operations.
